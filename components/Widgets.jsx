...
const Widgets = ({ trendingResults, followResults }) => {
    return (
        <div className='hidden lg:inline ml-8 2xl:w-[450px] py-1 space-y-5'>
            <div className="sticky top-0  py-1.5 bg-black z-50 w-11/12 2xl:w-9/12">
                <div className="flex items-center bg-[#202327] p-3 rounded-full relative">
                    <SearchIcon className='text-gray-500 h-5 z-50' />
                    <input type="text" placeholder='Search Twitter' className="bg-transparent focus:text-[#1d9bf0] rounded-full focus:bg-black focus:shadow-lg placeholder-gray-500 outline-none text-[#d9d9d9] absolute inset-0 pl-11 pr-1 border border-transparent w-full" />
                </div>
            </div>

            <div className='text-[#d9d9d9] space-y-3 bg-[#15181c] pt-2 rounded-xl w-11/12 2xl:w-9/12'>
