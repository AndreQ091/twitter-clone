...
import { collection, deleteDoc, doc, onSnapshot, orderBy, setDoc, query } from '@firebase/firestore';
  ...
  return (
    <div className="p-3 flex cursor-pointer border-b border-gray-700" onClick={() => router.push(`/${id}`)}>
      ...
      <div className="flex flex-col space-y-2 w-full">
        ...
        <img src={post?.image} alt={post?.title} className='rounded-2xl max-h-[700px] object-cover mr-2' />
